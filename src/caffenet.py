...
class CaffeNet(nn.Module):
    def __init__(self, protofile, width=864, height=864, channels=4, omit_data_layer=False, phase='TRAIN'):
    ...
    def create_network(self, net_info, input_width = None, input_height = None, input_channels = None):
        ...
        while i < layer_num:
            ...
            if ltype == 'Convolution':
                ...
                models[lname] = nn.ConvTranspose2d(in_channels, out_channels, kernel_size=kernel_size, stride = stride, padding=padding, bias=bias_term)
