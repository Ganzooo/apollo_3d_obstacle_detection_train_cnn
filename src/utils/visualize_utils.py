...
def get_input_feature_image(feature, height, width, thresh=0.0):
...
def get_category_or_confidence_image(feature, height, width, thresh=0.3):
    """Visualize category, confidece feature.
...
def get_class_image(feature, height, width):
    ...
    img[unknown] = [255, 255, 255]
    img = img.transpose(2, 0, 1)
    return img

def get_arrow_image(in_feature, out_feature, width=864, height=864,
                    grid_range=90., draw_target='instance', thresh=0.3,
